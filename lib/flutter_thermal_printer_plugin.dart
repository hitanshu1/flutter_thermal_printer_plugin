...
class FlutterThermalPrinterPlugin {
  ...
  FlutterThermalPrinterPlugin._() {
    _channel.setMethodCallHandler((MethodCall call) async {
      _methodStreamController.add(call);
    });
  }

  static FlutterThermalPrinterPlugin _instance = new FlutterThermalPrinterPlugin._();

  static FlutterThermalPrinterPlugin get instance => _instance;
